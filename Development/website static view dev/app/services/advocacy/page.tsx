      ...
      <section className="py-20 bg-[#004a90] text-white relative overflow-hidden">
        ...
        <div className="max-w-7xl mx-auto px-6 text-center relative z-10">
          ...
          <div className="flex flex-col sm:flex-row gap-4 justify-center">
            {/* STATIC VERSION - Contact buttons only */}
            <Button href="/contact" size="lg" className="bg-[#c3d021] text-[#194271] hover:bg-teravolta-lime-dark">
              {t('contactUs')}
            </Button>
            <Button href="/contact" variant="outline" size="lg" className="border-white text-white hover:bg-white hover:text-[#004a90]">
              {t('discussSituation')}
            </Button>
          </div>
        </div>
