          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 3xl:gap-20 items-center">
            <div>
              ...
              <div className="flex flex-col sm:flex-row gap-4">
                <Link
                  href="/quote"
                  className="inline-flex items-center justify-center font-medium rounded-full transition-colors whitespace-nowrap cursor-pointer px-8 py-4 text-lg bg-[#c3d021] hover:bg-[#a5b01c] text-[#194271]"
                >
