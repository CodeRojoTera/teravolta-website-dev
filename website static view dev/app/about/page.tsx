    ...
    <div className="min-h-screen bg-white">
      ...
      < section className="py-20 bg-white" >
        <div className="max-w-4xl mx-auto px-6 text-center">
          ...
          {/* STATIC VERSION - Only Contact button (No Quote) */}
          <div className="flex justify-center">
            <a
              href="/contact"
              className="px-8 py-3 rounded-full font-medium transition-colors cursor-pointer whitespace-nowrap border-2 border-[#004a90] text-[#004a90] bg-transparent"
              onMouseEnter={(e) => { (e.currentTarget as HTMLElement).style.backgroundColor = '#004a90'; (e.currentTarget as HTMLElement).style.color = '#FFFFFF'; }}
              onMouseLeave={(e) => { (e.currentTarget as HTMLElement).style.backgroundColor = 'transparent'; (e.currentTarget as HTMLElement).style.color = '#004a90'; }}
            >
              {t('about.contactUs') || 'Contáctanos'}
            </a>
          </div>
        </div>
      </section>
